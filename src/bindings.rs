...
const _: () = {
    ["Size of bpf_link_info__bindgen_ty_1__bindgen_ty_11"]
        [::std::mem::size_of::<bpf_link_info__bindgen_ty_1__bindgen_ty_11>() - 40usize];
...
extern "C" {
    pub fn ring_buffer__consume_n(rb: *mut ring_buffer, n: usize) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn ring__consume_n(r: *mut ring, n: usize) -> ::std::os::raw::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
